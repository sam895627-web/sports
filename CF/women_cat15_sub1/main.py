...
# Hardcoded subcategory URLs for Sports
SUBCATEGORY_URLS = [
    "https://www.boutiqaat.com/ar-kw/women/sports/sports-fitness-accessories-1/l/",
    "https://www.boutiqaat.com/ar-kw/women/sports/sports-bags-1/l/",
    "https://www.boutiqaat.com/ar-kw/women/sports/footwear-1/l/",
    "https://www.boutiqaat.com/ar-kw/women/sports/apparel-1/l/",
    "https://www.boutiqaat.com/ar-kw/women/sports/padel-1/l/",
]
...
class BoutiqaatDataPipeline:
                ...
                for idx, product in enumerate(products_in_sub, 1):
                    ...
                    try:
                        ...
                        if product.get('image_url'):
                            ...
                            product['r2_image_path'] = r2_image_path
                        else:
                            product['r2_image_path'] = 'No image available'
                    except Exception as e:
    ...
    def _upload_product_image(self, product: Dict, category_name: str, subcategory_name: str) -> str:
        try:
            ...
            r2_path = (
                f"boutiqaat-data/year={datetime.now().strftime('%Y')}/month={datetime.now().strftime('%m')}/day={datetime.now().strftime('%d')}/sports/images/"
                f"{safe_category}"
            )
    ...
    def _upload_excel_file(self, local_path: str, category_name: str) -> bool:
        try:
            ...
            r2_path = (
                f"boutiqaat-data/year={datetime.now().strftime('%Y')}/month={datetime.now().strftime('%m')}/day={datetime.now().strftime('%d')}/sports/excel-files"
            )
